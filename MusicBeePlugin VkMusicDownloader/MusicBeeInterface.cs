...
namespace MusicBeePlugin
{
    public partial class Plugin
    {
        ...
        public const short MinInterfaceVersion = 40;// 41
        ...
        public struct MusicBeeApiInterface
        {
            ...
            public void Library_SetDefaultFileTag(string sourceFileUrl, MetaDataType field, string value)
            {
                string currentValue = Library_GetFileTag(sourceFileUrl, field);
                if (currentValue is null || currentValue.Length == 0)
                    Library_SetFileTag(sourceFileUrl, field, value);
            }
        }
